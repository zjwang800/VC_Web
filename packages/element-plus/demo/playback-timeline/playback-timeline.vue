<template>
  ...
  import { VcPlaybackTimeline } from "@much-more/vc-element-plus";
  
  const defaultData = reactive({
    // 多个时间轴
    time3: '2025-01-15 00:00:00',
    timeSegments3: [
      {
        name: '时间段1',
        beginTime: new Date('2025-01-13 10:00:00').getTime(),
      ...
      {
        name: '时间段2',
        beginTime: new Date('2025-01-15 02:00:00').getTime(),
        endTime: new Date('2025-01-15 18:00:00').getTime(),
        color: '#836ABB',
        startRatio: 0.65,
        endRatio: 0.9
      }
    ...
    windowList: [
      {
        ...
        timeSegments: [
          ...
          {
            name: '窗口1的时间段2',
            beginTime: new Date('2025-01-12 18:00:00').getTime(),
            endTime: new Date('2025-01-13 00:00:00').getTime(),
            color: '#00AEFF',
            startRatio: 0.1,
            endRatio: 0.9
          }
